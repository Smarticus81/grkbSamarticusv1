...
const JOBS: Job[] = [
  ...
  },
  {
    ...
    evidenceRows: [
      { label: 'Complaint record', required: true },
      { label: 'Triage record', required: true },
      { label: 'Investigation record', required: true },
      { label: 'Reportability assessment', required: true },
    ],
  },
  {
  ...
  },
  {
    ...
    evidenceRows: [
      ...
      { label: 'Action plan', required: true },
      { label: 'Effectiveness check', required: true },
    ],
  },
  {
    ...
    obligationCount: 2,
    evidenceRows: [
      { label: 'Management review minutes', required: true },
      { label: 'QMS input summary', required: true },
      { label: 'Improvement action log', required: true },
    ],
  },
];
