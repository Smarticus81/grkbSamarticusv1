...
export function buildPsurModel(
  ...
  const sectionCoverageTable: PsurTableModel = {
    ...
    head: ['Section', 'Regulatory / standard basis', 'Evidence used', 'Traceable calculation / conclusion'],
    rows: [
      [
        'A Executive summary',
      ...
      [
        ...
        'literature',
        `${fmt(stats.literatureCount)} literature record(s) included in the safety/performance evidence set.`,
      ],
      [
  ...
  const reconciliationTable: PsurTableModel = {
    ...
    rows: [
      ...
      ['Benefit-risk conclusion', stats.benefitRiskFavourable ? 'Favourable' : 'Cannot be confirmed as favourable', 'Derived from trend signal and clinical/risk evidence'],
    ],
  };
