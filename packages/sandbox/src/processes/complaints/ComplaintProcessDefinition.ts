  ...
  steps: [
    {
      ...
      obligationIds: ['ISO13485.8.2.2.OBL.001', 'ISO13485.8.2.2.OBL.002', 'CFR820.198.OBL.001'],
      dependsOn: [],
      timeoutMs: 60_000,
    ...
    },
    {
      ...
      obligationIds: ['ISO13485.8.2.2.OBL.003', 'ISO13485.8.2.2.OBL.004', 'CFR820.198.OBL.002'],
      dependsOn: ['intake'],
      timeoutMs: 60_000,
      retryPolicy: { maxRetries: 2, backoffMs: 5_000 },
    },
    {
      ...
      obligationIds: ['ISO13485.8.2.2.OBL.003', 'EUMDR.87.OBL.001'],
      dependsOn: ['triage'],
      timeoutMs: 120_000,
      retryPolicy: { maxRetries: 2, backoffMs: 5_000 },
    },
    {
      ...
      obligationIds: ['EUMDR.87.OBL.001', 'EUMDR.87.OBL.002', 'EUMDR.87.OBL.003'],
